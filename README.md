...
<div align="center">
 ...
 <!-- LOGO -->
  ...
  <img src="./src/assets/shopping-cart.JPG" alt="logo" width="160"  height="auto" />
  <br/>
...
> Shopping Cart is an interactive app that fetches products from an API. The user could add and/or remove products from cart.
...
```sh
cd shopping-cart
https://github.com/anyars-encarta/shopping-cart.git
```
