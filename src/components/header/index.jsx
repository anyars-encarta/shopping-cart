...
const Header = () => (
  <div>
    ...
    <nav className='flex items-center justify-between pl-28 pr-28 mx-auto fixed top-0  w-full   bg-[#FBFBFB] py-2 shadow-md shadow-black/5 dark:bg-neutral-600 dark:shadow-black/10'>
      <Link to="/">
        <div className="ml-5">
